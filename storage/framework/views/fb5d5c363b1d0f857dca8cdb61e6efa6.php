...
<div class="mb-8 flex flex-col gap-4 border-b border-slate-100 pb-5 sm:flex-row sm:items-end sm:justify-between">
    <div>
        ...
        <h1 class="text-2xl font-semibold text-slate-900"><?php echo e($title); ?></h1>
...
<?php /**PATH D:\Kerjaan\Laravel\erp\resources\views/components/page-heading.blade.php ENDPATH**/ ?>