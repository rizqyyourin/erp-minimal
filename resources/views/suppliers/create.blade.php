...
@section('content')
    ...
    <x-page-heading title="New Supplier" description="Add a new supplier to your records" />
        ...
        <form method="POST" action="{{ route('suppliers.store') }}">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" name="lead_time_days" id="lead_time_days" value="{{ old('lead_time_days') }}" min="0"
                        class="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-slate-900 focus:border-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-500/20">
