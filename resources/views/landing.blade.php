...
<body class="min-h-full bg-white font-sans text-slate-900">
    <div class="relative">
        <header class="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('login') }}" class="hidden rounded-full border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:border-slate-300 md:inline-flex">Log in</a>
                <a href="{{ route('register') }}" class="rounded-full bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800">Start free trial</a>
            </div>
        </header>
        ...
        <section class="mx-auto mt-10 max-w-5xl px-6 text-center">
            ...
            <div class="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
                <a href="{{ route('register') }}" class="rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white hover:bg-slate-800">Start free trial</a>
                        ...
                        <div class="grid gap-6 p-10">
                            @foreach([
                                ...
                                <div class="rounded-2xl border border-slate-100 p-5">
                                    ...
                                    <p class="mt-2 text-sm text-slate-500">{{ $module['desc'] }}</p>
                                </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <section id="pricing" class="mx-auto mt-24 max-w-4xl px-6 text-center">
            ...
            <div class="mt-10 grid gap-6 md:grid-cols-2">
                <div class="rounded-3xl border border-slate-200 bg-white p-8 text-left">
                    ...
                    <a href="{{ route('dashboard') }}" class="mt-8 inline-flex rounded-full border border-slate-200 px-5 py-2 text-sm font-semibold text-slate-700 hover:border-slate-300">Launch free</a>
                </div>
        ...
        <section id="contact" class="mx-auto my-24 max-w-4xl rounded-3xl border border-slate-200 bg-white p-10 text-center">
            ...
            <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
                <a href="{{ route('dashboard') }}" class="rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white">Enter app</a>
        ...
        <footer class="border-t border-slate-100">
            <div class="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-6 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
                <p>© {{ date('Y') }} Minimal ERP. <a href="https://yourin.my.id" target="_blank" class="text-indigo-600 hover:underline">Yourin</a></p>
